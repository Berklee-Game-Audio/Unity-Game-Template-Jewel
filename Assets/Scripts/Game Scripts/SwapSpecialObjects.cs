...
public class SwapSpecialObjects : MonoBehaviour
{
    ...
    {
		Debug.Log ("ObjetsAreOfTypeUniversalAndHorizontal");
    ...
    {
		Debug.Log ("ObjetsAreOfTypeUniversalAndNone");
		GameOperations.instance.StopShowingHint();
    ...
    {
		Debug.Log ("ObjectsAreOfTypeHorizontal");
