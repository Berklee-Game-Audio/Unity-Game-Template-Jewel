...
public class SwapTwoObject : MonoBehaviour 
{
    ...
    {
		Debug.Log ("ChangePositionBack");
		//SoundFxManager.instance.wrongMoveSound.Play();
		AkSoundEngine.PostEvent ("sfx_incorrect_move", GameObject.Find ("WwiseGlobal"));
    ...
    {   
		Debug.Log ("Swipe");
		//AkSoundEngine.PostEvent ("sfx_big_swipe", GameObject.Find ("WwiseGlobal"));
